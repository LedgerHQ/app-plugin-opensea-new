...
typedef enum
{
  ...
  FO_ORDER_PARAM_CONSIDERATION_0_ITEM_TYPE,
  FO_ORDER_PARAM_CONSIDERATION_0_TOKEN,
  FO_ORDER_PARAM_CONSIDERATION_0_IDENTIFIER,
  FO_ORDER_PARAM_CONSIDERATION_0_START_AMOUNT,
  FO_ORDER_PARAM_CONSIDERATION_0_END_AMOUNT,
  FO_ORDER_PARAM_CONSIDERATION_0_RECIPIENT,
  FO_ORDER_PARAM_CONSIDERATION_1_ITEM_TYPE,
  FO_ORDER_PARAM_CONSIDERATION_1_TOKEN,
  FO_ORDER_PARAM_CONSIDERATION_1_IDENTIFIER,
  FO_ORDER_PARAM_CONSIDERATION_1_START_AMOUNT,
  FO_ORDER_PARAM_CONSIDERATION_1_END_AMOUNT,
  FO_ORDER_PARAM_CONSIDERATION_1_RECIPIENT,
  FO_ORDER_PARAM_CONSIDERATION_2_ITEM_TYPE,
  FO_ORDER_PARAM_CONSIDERATION_2_TOKEN,
  FO_ORDER_PARAM_CONSIDERATION_2_IDENTIFIER,
  FO_ORDER_PARAM_CONSIDERATION_2_START_AMOUNT,
  FO_ORDER_PARAM_CONSIDERATION_2_END_AMMOUNT,
  FO_ORDER_PARAM_CONSIDERATION_2_RECIPIENT,
  FO_ORDER_SIGNATURE,
